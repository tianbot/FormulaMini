...
![width:600px](assets/3/3-click_ssh.png)

---

![width:600px](assets/3/3-ssh-connect-host.png)

---
2. 在弹出菜单选：`Open SSH Host...` -> `Add New SSH Host...`

![width:600px](assets/3/3-add-ssh-host.png)

---

1. 弹出的框里输入：`ssh 用户名@IP地址`
- *例子*：`ssh sunrise@192.168.128.10`
![width:600px](assets/3/3-ssh-sunrise.png)
2. 按回车，选择第一个配置文件保存。
...
---
![width:600px](assets/3/3-ssh-connecting.png)
